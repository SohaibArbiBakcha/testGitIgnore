          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <a href="inscription.jsp" style="text-decoration: none">
              ...
              <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <a href="gestionEleve.jsp" style="text-decoration: none">
                      <p class="card-title text-md-center text-xl-left">
                        gestion
                      </p>
                      <div
              ...
              <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <a href="gestionPayment.jsp" style="text-decoration: none">
                      <p class="card-title text-md-center text-xl-left">
                        gestion
                      </p>
                      <div
              ...
              <div class="col-md-3 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <a href="gestionPlanning.jsp" style="text-decoration: none">
                      <p class="card-title text-md-center text-xl-left">
                        gestion
                      </p>
                      <div
