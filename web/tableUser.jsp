                        ...
                        <div class="row">
                            <div class="col-md-12 grid-margin">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <p class="font-weight-bold mb-0"><a href="menuAdmin.jsp" type="button" class="btn btn-sm btn-inverse-warning  btn-rounded btn-fw">accueil</a> | <a href="gestionEmployer.jsp" type="button" class="btn btn-sm btn-inverse-warning  btn-rounded btn-fw">Gestion Employer</a> | Table Employer </p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <form class="form-inline">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label">Statu employe</label>
                                                    <div class="col-sm-3">
                                                        <select class="form-control" id="selstat"> 
